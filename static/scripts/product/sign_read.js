!function(){
					...
					if( !data ){
						...
						$.each( data, function( key, val ){
							...
							switch(parseInt(val['type'])){
								case 1 : _type = 'music';break;
								case 2 : _type = 'person';break;
								case 3 : _type = 'brand';break;
								case 4 : _type = 'prop';break;
								case 5 : _type = 'topic';break;
								case 6 : _type = 'action';break;
							}
		...
		$('body').delegate('.adshow',{
			...
			mouseleave : function(){
				...
				if(vtype == "4"){
			        ...
			        var bid = $(this).find('.adsTitle')["bid"]
			        $.post('/sign/'+id+'/action',{action:action, bid:bid},function(data){},"json");
		    	}
			}
					...
					$.each( play.ads, function( key, val ){
						if(_time == val['time']){
							...
							//if(val['img'] == null){
								...
								var docu = "<a bid='"+ val['id'] +"' style='"+loca+";"+style+"' href='"+val['url']+"' data-index='"+key+"' class='adsTitle' target='_blank'>"+val['title']+"</a>";

							} else {

								var docu = "<span bid='"+ val['id'] +"' style='"+loca+";"+style+"' class='adsTitle' data-index='"+key+"'>"+val['title']+"</span>";
	...
	play.innerHTML = function(){
		...
		var _html = '<div id="controlBox"><div id="controlBar"><div id="progBtnBar"><span id="PreLoad"></span><span id="pregTimeBar"></span></div><span id="playBtn" class="icon-ion-ios-play Btn"></span><span id="showTime"><b id="currTime">00:00:00</b> / <b id="totalTime">00:00:00</b></span><span id="FullScreen" class="icon-ion-arrow-expand Btn"></span><div id="volumeBox"><div id="volumeBar"><div id="volumeMask"><span id="volume"><span id="volume2"></span></span></div></div><span id="OpenVolBtn" class="icon-ion-android-volume-up Btn"></span></div></div></div><span id="addBtn"></span><div id="mask"></div><div id="eJectBox"><div class="eJectCloseBox"><span class="eJectClose">close</span></div><img class="eJectImg" src="/static/images/bg_img.png" /><div class="eJectRight"><span class="eJectTitle"></span><p class="eJectContent"><ul><li><p>1.I am familiar with this product</p><div ><input type="range" min="0" max="10" step="1" value="10" ></div></li></ul></p><a href="" class="eJectJump" target="_blank">more</a></div></div><div id="panelBox"><span class="close">close</span><span class="existing">source</span><span class="handadd">手动添加</span><div id="showBox"></div></div>';
